...
import { FEE_LEVEL } from '../constants';
...
export async function getBuyTx(solanaConnection: Connection, wallet: Keypair, baseMint: PublicKey, quoteMint: PublicKey, amount: number, targetPool: string) {
  ...
  const quoteTokenAmount = new TokenAmount(quoteToken, amount)
...
export async function getSellTx(solanaConnection: Connection, wallet: Keypair, baseMint: PublicKey, quoteMint: PublicKey, targetPool: string, amount: string | undefined) {
  try {
